  ...
  "intern-qdzl": {
    ...
    html: `
      ...
      <div class="modal-section">
        ...
        <p class="muted">
          This school-enterprise training project covered online sales of Wahaha beverages, Junlebao yogurt, and accessory rings across multiple categories. Initial challenges included cluttered product keywords, disorganized detail page layouts, and homogenized promotional short videos — the organic in-store conversion rate was only 3%. The goal was to refine product operations around individual SKUs through listing optimization and proprietary content publishing, boosting organic traffic and transaction conversion.
        </p>
      </div>
      ...
      <div class="modal-section">
        ...
        <ul class="bullet">
          ...
          <li>
            End-to-end content execution: Independently produced short video scripts, on-camera shoots, and post-production editing around product features; split content into lifestyle seeding and in-depth review formats for A/B testing; tracked impressions, clicks, and in-store conversion data using Excel.
          </li>
          <li>
  ...
  "project-nanospace": {
    ...
    html: `
      ...
      <div class="modal-section">
        ...
        <ul class="bullet">
          <li>
            <strong>Requirements & product definition:</strong> Deep-dived into subdivided-flat residents' spatial anxiety and confinement pain points; architected the product around A-Frame + Web Audio API for 360° panoramic scenes with ambient white noise; designed two core features — a customizable environment "comfort bar" and spatial anchor transitions — to mitigate VR motion sickness from virtual-real switching; produced complete user personas and deployment scenario documentation.
          </li>
          <li>
  ...
  "project-echoes": {
    ...
    html: `
      ...
      <div class="modal-section">
        ...
        <ul class="bullet">
          <li>
            <strong>Requirements & solution definition:</strong> Led the design of a "1+N" world-building framework, completed functional and gameplay definitions for 9 puzzle levels, and delivered a comprehensive game rules document; established product interaction standards using Unity + SteamVR and collaborated with engineering on FOV dynamic narrowing for anti-motion-sickness implementation.
          </li>
          <li>
            <strong>Cross-team coordination & performance optimization:</strong> Aligned an 8-person cross-functional team (programming / art / QA), broke down the project timeline with phased acceptance criteria; implemented three rendering optimization approaches — polygon count control, idle collider cleanup, and scene chunking with async loading — to address on-scene frame-drop issues.
          </li>
          <li>
            <strong>User feedback & iterative improvement:</strong> Incorporated multi-round internal testing feedback, replaced native smooth movement with Teleport mode paired with dynamic FOV narrowing algorithms; after multiple debugging rounds, significantly reduced VR motion sickness incidence and established reusable design guidelines.
          </li>
        </ul>
      </div>
    ...
    html: `
      ...
      <div class="modal-section">
        ...
        <ul class="bullet">
          ...
          <li>
            <strong>Results delivery & project completion:</strong> Authored patent technical disclosure documents as primary inventor, filed and obtained approval for 2 utility model patents covering wastewater purification catalytic structures; consolidated experimental data, completion materials, and defense preparation.
          </li>
        </ul>
      </div>
      ...
      <div class="modal-section">
        <div class="modal-section-title">3. Output & Value</div>
        <p class="muted">
          Successfully delivered a physical prototype of the solar photocatalytic wastewater treatment device; 2 utility model patents officially approved; project ultimately earned National-level Excellent Completion; the R&D approach can serve as a reference for small-scale decentralized wastewater treatment solutions.
        </p>
      </div>
      ...
      <div class="modal-section">
        <div class="modal-section-title">4. Skills Gained</div>
        <p class="muted">
          Developed full-cycle project management capabilities for hardware research projects, including cross-module coordination and technical breakthroughs. Proficient in patent commercialization, project risk control, and high-level project completion processes, with a rigorous R&D delivery and project management mindset.
        </p>
      </div>
      <div class="modal-section">
        <div class="img-grid img-grid-2">
  ...
  "practice-flag": {
    ...
    html: `
      ...
      <div class="modal-section">
        ...
        <ul class="bullet">
          <li>Regularly participated in ceremonial training, executed over 100 flag-raising and patriotic education events, reaching 50,000+ students and faculty.</li>
          <li>Managed content operations across WeChat public account, Weibo, and QQ Space — independently handled topic selection, writing, and layout, publishing 100+ articles and producing 3 promotional short films.</li>
  ...
  "practice-beijing": {
    ...
    html: `
      ...
      <div class="modal-section">
        <div class="modal-section-title">3. Results & Takeaways</div>
        <p class="muted">
          Successfully completed all research visits and article output tasks, with comprehensive first-hand research materials consolidated. Developed skills in project planning, remote itinerary coordination, field interviewing, and document writing. Gained practical experience in red culture research execution and team task division management.
        </p>
      </div>
      <div class="modal-section">
        <div class="img-grid img-grid-2">
  ...
  "practice-tuangzhi": {
    ...
    html: `
      ...
      <div class="modal-section">
        <div class="modal-section-title">2. Execution</div>
        <ul class="bullet">
          <li>Fully responsible for daily operations of two college new media platforms, including copy editing and content publishing, completing 50+ activity notices, news updates, and themed promotional posts.</li>
      ...
      <div class="modal-section">
        <div class="modal-section-title">3. Results & Takeaways</div>
        <p class="muted">
          Consistently delivered high-quality promotional content, effectively increasing participation in college activities and campus visibility, strengthening the college's publicity presence. Mastered new media content planning, graphic layout, visual material production, and promotion effectiveness review. Accumulated systematic, multi-channel propaganda operations experience.
        </p>
      </div>
      <div class="modal-section">
        <div class="img-grid img-grid-2">
